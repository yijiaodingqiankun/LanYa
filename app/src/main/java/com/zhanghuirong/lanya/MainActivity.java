package com.zhanghuirong.lanya;
...
import com.zhanghuirong.lanya.adapter.BlueListAdapter;
import com.zhanghuirong.lanya.bean.BlueDevice;
import com.zhanghuirong.lanya.task.BlueAcceptTask;
import com.zhanghuirong.lanya.task.BlueConnectTask;
import com.zhanghuirong.lanya.task.BlueReceiveTask;
import com.zhanghuirong.lanya.util.BluetoothUtil;
import com.zhanghuirong.lanya.widget.InputDialogFragment;

import java.io.IOException;
import java.lang.reflect.Method;
import java.util.ArrayList;

public class MainActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener, View.OnClickListener, AdapterView.OnItemClickListener,
...
//                Log.d(TAG, "开始配对");
    ...
    private Runnable mAccept = new Runnable() {
        ...
        public void run() {
            if (mBluetooth.getState() == BluetoothAdapter.STATE_ON) {
                ...
                acceptTask.setBlueAcceptListener(MainActivity.this);
    ...
    public void onInput(String SSID, String password, int type) {
        BluetoothUtil.writeOutputStream(mBlueSocket, password);
    }
...
//        Log.d(TAG, "onBlueAccept socket is " + (socket == null ? "null" : "not null"));
    ...
    private void beginDiscovery() {
        if (mBluetooth.isDiscovering() != true) {
            mDeviceList.clear();
            BlueListAdapter adapter = new BlueListAdapter(MainActivity.this, mDeviceList);
            lv_bluetooth.setAdapter(adapter);
...
//            Log.d(TAG, "onReceive action=" + action);
            ...
            if (action.equals(BluetoothDevice.ACTION_FOUND)) {
                ...
                BlueListAdapter adapter = new BlueListAdapter(MainActivity.this, mDeviceList);
                lv_bluetooth.setAdapter(adapter);
                lv_bluetooth.setOnItemClickListener(MainActivity.this);
