package com.zhanghuirong.lanya.adapter;
...
import com.zhanghuirong.lanya.R;
...
public class BlueListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tv_blue_name = (TextView) convertView.findViewById(R.id.tv_name);
            holder.tv_blue_address = (TextView) convertView.findViewById(R.id.tv_address);
            holder.tv_blue_state = (TextView) convertView.findViewById(R.id.tv_start);
